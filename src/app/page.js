    ...
    <main className="relative z-10 overflow-x-hidden">
      ...
      <div
        className="
          ...
          sm:top-[110px] sm:left-auto sm:translate-x-0 sm:right-[-150px] /* mantém desktop igual */
      ...
      <section id="sobre-nos" className="relative z-10 px-4 py-10 sm:px-10">
        <h2 className="text-xl sm:text-3xl font-bold text-[color:var(--title)] mb-10 text-left">
          SOBRE NÓS
        </h2>

        <div className="flex flex-col sm:flex-row gap-16 sm:gap-32 justify-start pl-4 sm:pl-32 sm:py-7">
          {[
            ...
            <div
              ...
              className="group flex items-center gap-4
                sm:block sm:max-w-[300px] sm:w-full sm:relative"
            >
              <Image
                src={image}
                width={200}
      ...
      <section className="relative z-10 px-4 py-10 sm:px-10">
        <h2 className="text-lg sm:text-3xl font-semibold text-[color:var(--title)] mb-6 text-left sm:text-left">
          ÚLTIMAS DOCUMENTAÇÕES
        </h2>
        <div className="flex flex-col sm:py-10 sm:pl-32 sm:flex-row gap-6 sm:gap-16 items-start">
          <div className="w-full sm:w-[40%] max-w-[500px]"> 
            <Image 
              src="/formulario.png" 
              width={500}
              height={400} 
              alt="Imagem demonstrativa do formulário documentado"
              className="border-4 border-[var(--primary-color)] rounded-lg w-full h-auto object-cover sm:max-w-[500px]"
            />
          </div>

          <div className="w-full sm:w-[60%] mt-6 sm:mt-0">
            <h3 className="text-lg sm:text-2xl font-semibold text-[color:var(--title)]">
              DIÁRIO DE BORDO CENTROWEG
            </h3>

            <p className="text-sm sm:text-lg pt-2 font-medium text-[color:var(--subtitle)] pb-6 max-w-md">
              Diário de bordo escolar voltado ao controle diário das aulas aplicadas.
            </p>

            <Link
              href="/docs/introducao"
              className="inline-block px-4 py-2 bg-[var(--primary-color)] text-white rounded-md text-sm sm:text-base hover:bg-[var(--secondary-color)] transition-colors duration-300"
            >
